 ...
 * Class:           BSTPrint
 * 
 * Class has been modified to support generic type nodes, otherwise is copied from ZyBooks textbook
 */
class BSTPrint {
    public static <T> String treeToString(Node<T> subtreeRoot) {
       if (subtreeRoot == null) {
          return "(empty tree)";
       }
    ...
    private static <T> String[] treeToLines(Node<T> subtreeRoot) {
       if (subtreeRoot == null) {
          return new String[0];
       }
